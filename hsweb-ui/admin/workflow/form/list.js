...
importMiniui(function () {
    ...
    require(["miniui-tools"], function (tools) {
        ...
        tools.initGrid(grid);
        grid.setUrl(API_BASE_PATH + "dynamic/form");
        ...
        function search() {
            ...
            require(["request"], function (request) {
                ...
                grid.load(query.getParams(param));
            });
        }
        ...
        $(".add-menu-button").on("click", function () {
            tools.openWindow("admin/workflow/form/save.html", "新建表单", "80%", "80%", function () {
                grid.reload();
            });
        });
    });
...
window.renderAction = function (e) {
    ...
    html.push(tools.createActionButton("编辑", "icon-edit", function () {
        tools.openWindow("admin/workflow/form/save.html?id=" + row.id, "编辑表单" + row.name, "80%", "80%", function () {
            grid.reload();
        });
    }));
